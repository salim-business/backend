...
(function($){
    ...
    class MultiCurrency {
        constructor() {
            ...
            window.initCurrencyData();
            this.load();
        }
        
        load() {
            const cookieCurrency = theme.Cookie.get('currency');
            ...
            function cheackList(currentCurrency) {
                ...
                $('.js-currencies-list').find('li').each(function () {
                    var $this = $(this);
            ...
            if(cookieCurrency != null && cookieCurrency !== Currency.shopCurrency) {
                ...
                var $current_currency = $('.js-currencies-list').find('[data-current-currency]');

                $current_currency.html(button_name);
            }
            
            $(document).on('click', '.js-currencies-list li', function (e) {
                var $this = $(this);
                var $current_currency = $('.js-currencies-list').find('[data-current-currency]');
                ...
                if(!$this.hasClass('active')) {
                    ...
                    theme.MultiCurrency.setCurrency(newCurrency);
        ...
        formatAndUpdate(price) {
            this.multipleCurrenciesWrapper.html(Shopify.formatMoney(price * 100, theme.moneyFormat));
            this.update();
            
            const moneyHTML = this.multipleCurrenciesWrapper.html();

            this.multipleCurrenciesWrapper.html('');
    ...
    theme.AssetsLoader.onPageLoaded(function() {
        theme.MultiCurrency = new MultiCurrency;
    });
})(jQueryTheme);